...
"
	...
	},
	{
		...
		image = "",
		effect = "El otro día le dije a mi madre que quería comprarme una nueva lámpara y ahora me recomiendan escape rooms de miedo MUY OSCUROS por internet. Claramente a todo el mundo le ha pasado y por eso te van a seguir más.",
	},
	{
		id = 12,
